    ...
    return {
      ...
      link: function (scope, elem) {
        ...
        Auth.getCurrentUser().profile.$loaded().then(function (profileData) {
          if (!profileData.bankAccountToken && !profileData.balancedBankAccountId && (profileData.creditCardToken || profileData.stripeCustomerId)) { elem.find('.hidden').removeClass('hidden'); }
